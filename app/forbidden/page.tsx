...
import {
	forbiddenContentByReason,
	parseForbiddenReason,
} from "@/lib/authorization/forbidden"
...
export default async function ForbiddenPage({
	...
	const reason = parseForbiddenReason(resolvedSearchParams.reason)
	const content = reason
		? forbiddenContentByReason[reason]
		: forbiddenContentByReason.default
