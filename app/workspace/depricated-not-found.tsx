...
export default function AppNotFound() {
	...
	return (
		<div className="relative -mx-4 -my-6 flex min-h-[calc(100svh-7rem)] items-center justify-center overflow-hidden bg-linear-to-b from-background via-background to-muted/30 px-4 py-10 md:-mx-6 md:-my-8 md:min-h-[calc(100svh-8rem)] xl:-mx-8">
			<div className="text-center">
				...
				<p className="text-muted-foreground mx-auto mt-3 max-w-xl text-sm leading-6 sm:text-base">
					This workspace page does not exist, or the route changed while your
					organization context was updating.
				</p>
