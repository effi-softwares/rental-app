...
--> statement-breakpoint
ALTER TABLE "rental_inspection" ADD COLUMN "condition_rating" "rental_condition_rating";--> statement-breakpoint
ALTER TABLE "vehicle" ADD COLUMN "vehicle_class_id" uuid;--> statement-breakpoint
ALTER TABLE "vehicle" ADD COLUMN "latest_condition_snapshot" jsonb;--> statement-breakpoint
...
ALTER TABLE "vehicle" ADD CONSTRAINT "vehicle_vehicle_class_id_vehicle_class_id_fk" FOREIGN KEY ("vehicle_class_id") REFERENCES "public"."vehicle_class"("id") ON DELETE set null ON UPDATE no action;